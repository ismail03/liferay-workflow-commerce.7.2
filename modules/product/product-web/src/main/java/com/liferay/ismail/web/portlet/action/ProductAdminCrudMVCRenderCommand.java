...
import com.liferay.ismail.web.upload.ProductItemSelectorHelper;
...
public class ProductAdminCrudMVCRenderCommand implements MVCRenderCommand {

	/**
	 * Edit Page JSP file
	 */
	public String getEditPageJSP() {
		return ProductWebKeys.ADMIN_EDIT_JSP;
	}
	...
	public String getViewRecordPageJSP() {
		return ProductWebKeys.ADMIN_VIEW_RECORD_JSP;
	}
...
// //
		request.setAttribute(
			ProductWebKeys.PRODUCT_ITEM_SELECTOR_HELPER,
			_productItemSelectorHelper);
	...
	protected String add(
		...
		throws PortalException, PortletException, ProductValidateException {

		Product record = null;

		if (Validator.isNull(request.getParameter("addErrors"))) {
			record = _productService.getInitializedProduct(
				primaryKey, request);
		}
		else {
			record = _productService.getProductFromRequest(
				primaryKey, request);
		}
	...
	protected String update(
		...
		Product record = _productService.getProduct(primaryKey);
...
// //
	...
	@Reference
	private ProductItemSelectorHelper _productItemSelectorHelper;
