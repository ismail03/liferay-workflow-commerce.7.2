 ...
 * @author user
 */
public class ProductAssetRenderer
	extends BaseJSPAssetRenderer<Product> implements TrashRenderer {

	public ProductAssetRenderer(
		Product entry, ResourceBundleLoader resourceBundleLoader) {
	...
	public String getJspPath(HttpServletRequest request, String template) {
		if (template.equals(TEMPLATE_ABSTRACT) ||
			...
			request.setAttribute("product", _entry);

			return "/product/asset/" + template + ".jsp";
		}
...
//  //
        return _entry.getProductTitleName();
// //		
	}
...
//  //	
	...
	public String getType() {
		return ProductAssetRendererFactory.TYPE;
	}
	...
	public PortletURL getURLEdit(
		...
		PortletURL portletURL = PortalUtil.getControlPanelPortletURL(
			liferayPortletRequest, group, ProductPortletKeys.PRODUCT_ADMIN, 0,
	...
	public String getURLViewInContext(
		...
		return getURLViewInContext(
			liferayPortletRequest, noSuchEntryRedirect, "/product/crud",
